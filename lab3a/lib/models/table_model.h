...
int table_delete_by_keys(Table *table, char *key1, char *key2); 
int table_delete_in_ks1(Table *table, char *key); 
int table_delete_in_ks2(Table *table, char *key); 
int table_delete_version_in_ks1(Table *table, char *key, int version); 
